...
public class SnowflakeId {
    ...
    private static SnowflakeId instance = getInstance();
    ...
    public static String getId() {
        ...
        String resultId = String.valueOf(id);
        return resultId;
    }
    ...
    public static void getDate() {
        ...
        Date parse = null;
        try {
            String dateStr = "2015-01-01 12:12:13";
            parse = DateFormat.getDateInstance().parse(dateStr);
