...
@MapperScan(basePackages = PrdDatasourceConfig.PACKAGE, sqlSessionFactoryRef = "prdSqlSessionFactory")
public class PrdDatasourceConfig {
// implements TransactionManagementConfigurer

    // 精确到 master 目录，以便跟其他数据源隔离
    static final String PACKAGE = "com.lin.common.dao.prdDao";
    static final String MAPPER_LOCATION = "classpath:mapper/prd/*.xml";
    ...
    @Bean
    public SqlSessionFactory prdSqlSessionFactory() {
        try {
            final SqlSessionFactoryBean sessionFactory = new SqlSessionFactoryBean();
            sessionFactory.setDataSource(prdDataSource());
